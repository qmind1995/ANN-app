...
BatchTrainer::BatchTrainer(NeuralNetwork *untrainedNetwork, double _learningRate,
                           int _epoch, double _desiredMSE, int _batchSize)
                            :Trainer(untrainedNetwork, _learningRate, _epoch, _desiredMSE),
                              NN(untrainedNetwork),
                              learningRate(_learningRate),
                              maxEpochs(_epoch),
                              epoch(0),
                              desiredMSE(_desiredMSE),
